...
/**
 * 1. "MoneyAccount" - это (переменая) иммитирует денежный счет
 * 2. "BrokenCachePoint" - это (простой метод) иммитирует оибочное выполнения денежного снятия
 * 2. "CachePoint" - это (синхронизированый метод) иммитирует исправное выполнения денежного снятия
 *
 * *********************************************************************************************
 ...
 *
 * Ожидаемый результат: 2 участника могут снять деньги, а 3-ий получает сообщение о том, что денег недостаточно
 * Реальные возможные результаты:
 * а) Все 3-е смогут снять деньги.
 * 6) Смогут снять только 2-е
 *
